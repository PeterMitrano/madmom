...
class SyncronizeFeaturesProcessor(Processor):
    ...
    for a subdivision is found, it is interpolated.
    ...
    def process(self, data, **kwargs):
        ...
        Sum all feature values that fall into a window of beat duration /
...
class DBNBarTrackingProcessor(Processor):
    ...
    def process(self, data, **kwargs):
        ...
        data : numpy array, shape (num_beats, 2)
            Array containing beat positions and corresponding downbeat
            activations.
